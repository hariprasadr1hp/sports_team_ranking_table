...
├── __pycache__
│   ├── __init__.cpython-38.pyc
│   ├── test_basic.cpython-38-pytest-6.2.4.pyc
│   ├── test_epl.cpython-38-pytest-6.2.4.pyc
│   ├── test_example.cpython-38-pytest-6.2.4.pyc
│   ├── test_model.cpython-38-pytest-6.2.4.pyc
│   ├── test_premilinary.cpython-38-pytest-6.2.4.pyc
│   ├── test_ranking.cpython-38-pytest-6.2.4.pyc
│   └── test_record.cpython-38-pytest-6.2.4.pyc
├── test_basic.py
├── test_epl.py
├── test_match
├── test_model.py
...
tests/test_match.py::test_match_results:
  ...
  - during generate phase (0.12 seconds):
    ...
    - Events:
      ,* 8.08%, A(8) vs B(4) ==> A: Result.WIN --- B: Result.LOSS
      ,* 6.06%, A(6) vs B(16) ==> A: Result.LOSS --- B: Result.WIN
      ,* 6.06%, A(9) vs B(4) ==> A: Result.WIN --- B: Result.LOSS
      ,* 5.05%, A(16) vs B(16) ==> A: Result.DRAW --- B: Result.DRAW
      ,* 4.04%, A(4) vs B(4) ==> A: Result.DRAW --- B: Result.DRAW
      ,* 4.04%, A(7) vs B(6) ==> A: Result.WIN --- B: Result.LOSS
      ,* 3.03%, A(11) vs B(4) ==> A: Result.WIN --- B: Result.LOSS
      ,* 3.03%, A(13) vs B(13) ==> A: Result.DRAW --- B: Result.DRAW
      ,* 3.03%, A(13) vs B(2) ==> A: Result.WIN --- B: Result.LOSS
      ,* 3.03%, A(17) vs B(17) ==> A: Result.DRAW --- B: Result.DRAW
      ,* 3.03%, A(19) vs B(7) ==> A: Result.WIN --- B: Result.LOSS
      ,* 2.02%, A(0) vs B(0) ==> A: Result.DRAW --- B: Result.DRAW
      ,* 2.02%, A(11) vs B(7) ==> A: Result.WIN --- B: Result.LOSS
      ,* 2.02%, A(13) vs B(7) ==> A: Result.WIN --- B: Result.LOSS
      ,* 2.02%, A(14) vs B(4) ==> A: Result.WIN --- B: Result.LOSS
      ,* 2.02%, A(18) vs B(2) ==> A: Result.WIN --- B: Result.LOSS
      ,* 2.02%, A(19) vs B(19) ==> A: Result.DRAW --- B: Result.DRAW
      ,* 2.02%, A(19) vs B(6) ==> A: Result.WIN --- B: Result.LOSS
      ,* 2.02%, A(6) vs B(6) ==> A: Result.DRAW --- B: Result.DRAW
      ,* 2.02%, A(7) vs B(4) ==> A: Result.WIN --- B: Result.LOSS
      ,* 2.02%, A(9) vs B(0) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(0) vs B(13) ==> A: Result.LOSS --- B: Result.WIN
      ,* 1.01%, A(0) vs B(6) ==> A: Result.LOSS --- B: Result.WIN
      ,* 1.01%, A(1) vs B(2) ==> A: Result.LOSS --- B: Result.WIN
      ,* 1.01%, A(10) vs B(18) ==> A: Result.LOSS --- B: Result.WIN
      ,* 1.01%, A(14) vs B(0) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(14) vs B(10) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(14) vs B(20) ==> A: Result.LOSS --- B: Result.WIN
      ,* 1.01%, A(14) vs B(5) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(15) vs B(10) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(17) vs B(0) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(17) vs B(6) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(18) vs B(10) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(18) vs B(6) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(18) vs B(7) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(19) vs B(10) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(19) vs B(16) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(19) vs B(5) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(20) vs B(0) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(20) vs B(10) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(20) vs B(4) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(3) vs B(14) ==> A: Result.LOSS --- B: Result.WIN
      ,* 1.01%, A(4) vs B(18) ==> A: Result.LOSS --- B: Result.WIN
      ,* 1.01%, A(5) vs B(0) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(5) vs B(10) ==> A: Result.LOSS --- B: Result.WIN
      ,* 1.01%, A(5) vs B(3) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(6) vs B(3) ==> A: Result.WIN --- B: Result.LOSS
      ,* 1.01%, A(7) vs B(16) ==> A: Result.LOSS --- B: Result.WIN
      ,* 1.01%, A(8) vs B(10) ==> A: Result.LOSS --- B: Result.WIN
      ,* 1.01%, A(9) vs B(11) ==> A: Result.LOSS --- B: Result.WIN
      ,* 1.01%, A(9) vs B(19) ==> A: Result.LOSS --- B: Result.WIN
      ,* 1.01%, A(9) vs B(6) ==> A: Result.WIN --- B: Result.LOSS

  - Stopped because settings.max_examples=100


1 passed, 9 deselected in 0.15s
#+end_example
...
tests/test_model.py::test_model_same_rank:
  ...
  - during generate phase (0.18 seconds):
    ...
    - 100 passing examples, 0 failing examples, 0 invalid examples
    - Events:
      ,* 7.00%, '['alpha', 'epsilon', 'iota', 'psi', 'upsilon']' have same rank(1), because they share same points (0)
      ,* 4.00%, '['alpha', 'psi']' have same rank(3), because they share same points (115)
      ,* 3.00%, '['alpha', 'iota']' have same rank(4), because they share same points (105)
      ,* 3.00%, '['epsilon', 'iota', 'psi', 'upsilon']' have same rank(1), because they share same points (232)
      ,* 2.00%, '['alpha', 'epsilon']' have same rank(4), because they share same points (51)
      ,* 2.00%, '['alpha', 'psi']' have same rank(3), because they share same points (141)
      ,* 2.00%, '['epsilon', 'psi']' have same rank(2), because they share same points (232)
      ,* 2.00%, '['epsilon', 'upsilon']' have same rank(1), because they share same points (319)
      ,* 2.00%, '['epsilon', 'upsilon']' have same rank(4), because they share same points (216)
      ,* 1.00%, '['alpha', 'epsilon', 'upsilon']' have same rank(1), because they share same points (319)
      ,* 1.00%, '['epsilon', 'iota', 'psi']' have same rank(2), because they share same points (176)
      ,* 1.00%, '['epsilon', 'iota', 'psi']' have same rank(2), because they share same points (232)
      ,* 1.00%, '['epsilon', 'psi']' have same rank(2), because they share same points (176)
      ,* 1.00%, '['epsilon', 'upsilon']' have same rank(1), because they share same points (241)
      ,* 1.00%, '['epsilon', 'upsilon']' have same rank(2), because they share same points (127)

  - Stopped because settings.max_examples=100


1 passed, 9 deselected in 0.22s
#+end_example
